  ...
  return (
    <form onSubmit={onSubmit} autoComplete="off" className="space-y-4 animate-in fade-in">
      ...
      <div className="p-3.5 rounded-2xl bg-zinc-50 border border-zinc-200 space-y-2">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-white border border-zinc-300 rounded-xl pl-10 pr-4 py-2.5 text-xs text-zinc-950 placeholder-zinc-400 focus:outline-none focus:border-black font-mono tracking-widest font-extrabold uppercase transition"
          />
        </div>
      </div>
      ...
      {resolvedClassroom ? (
        ...
        <div className="p-3 rounded-2xl bg-amber-50 border border-amber-200 text-amber-900 text-xs flex items-center gap-2 animate-in fade-in">
          <span>No classroom found with code <strong className="font-mono">{joinCode}</strong>. Please check the code with your Class Representative.</span>
        </div>
      ) : (
        <div className="p-3 rounded-2xl bg-zinc-50 border border-zinc-200 text-zinc-500 text-xs text-center">
      ...
      <div className="space-y-3 pt-1">
        <h4 className="text-[11px] font-black uppercase tracking-wider text-zinc-950 flex items-center gap-1.5">
          <UserIcon className="w-3.5 h-3.5 text-zinc-900" />
          Your Student Enrollment Information
        </h4>

        <div>
          <label className="block text-xs font-medium text-zinc-800 mb-1">
            Student Full Name <span className="text-zinc-900">*</span>
          </label>
          <input
            type="text"
            required
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            <label className="block text-xs font-medium text-zinc-800 mb-1">
              Roll Number / Student ID <span className="text-zinc-900">*</span>
            </label>
            <input
              type="text"
              required
              ...
              className="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-3.5 py-2 text-xs text-zinc-900 focus:bg-white focus:outline-none focus:border-black font-mono font-bold transition"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-3.5 py-2 text-xs text-zinc-900 focus:bg-white focus:outline-none focus:border-black font-mono transition"
            />
          </div>
        </div>
          ...
          <div className="flex gap-2">
            <input
              ...
              className={`flex-1 bg-zinc-50 border ${
                isStudentEmailVerified ? 'border-emerald-500 text-emerald-800' : 'border-zinc-200 text-zinc-900'
        ...
        <div>
          <label className="block text-xs font-medium text-zinc-800 mb-1">
            Create Password <span className="text-zinc-900">*</span>
          </label>
          <div className="relative">
            <input
      ...
      <button
        type="submit"
        className="w-full py-3.5 rounded-2xl bg-black hover:bg-zinc-800 text-white text-xs font-bold shadow-sm transition flex items-center justify-center gap-2 mt-2 active:scale-[0.99] cursor-pointer"
      >
