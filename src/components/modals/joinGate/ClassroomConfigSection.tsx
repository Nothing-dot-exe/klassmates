...
export const ClassroomConfigSection: React.FC<ClassroomConfigSectionProps> = ({
  ...
  return (
    <div className="space-y-3 pt-2 border-t border-zinc-200 dark:border-[#1F2A44]">
      ...
      <div>
        ...
        <input
          ...
          className="w-full bg-zinc-50 dark:bg-[#121A2D] border border-zinc-200 dark:border-[#1F2A44] rounded-xl px-3.5 py-2 text-xs text-indigo-600 dark:text-indigo-400 font-mono font-bold tracking-widest focus:bg-white dark:focus:bg-[#161F36] focus:outline-none focus:border-indigo-500 dark:focus:border-indigo-500 uppercase transition shadow-xs"
        />
      </div>
    </div>
  );
