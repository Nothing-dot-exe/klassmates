  ...
  return (
    <div className="p-3.5 rounded-2xl bg-zinc-50 border border-zinc-200 space-y-3">
      <div className="flex items-center justify-between">
        <label className="text-[11px] font-bold text-zinc-800 uppercase tracking-wider flex items-center gap-1.5">
          <ImageIcon className="w-3.5 h-3.5 text-zinc-950" />
          <span>Profile Photo or GIF</span>
        </label>
        {isGif && (
          <span className="text-[10px] font-extrabold px-1.5 py-0.2 rounded bg-zinc-100 text-zinc-900 border border-zinc-300 animate-pulse">
            Animated GIF ✨
          </span>
        )}
      </div>
      ...
      <div className="flex items-center gap-3.5">
        {/* Avatar Preview */}
        <div className="relative flex-shrink-0 p-[2px] rounded-full border border-zinc-300 shadow-2xs">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src={previewAvatar}
            alt="Avatar Preview"
            className="w-16 h-16 rounded-full object-cover bg-zinc-100 ring-2 ring-white"
          />
        </div>
        ...
        <div className="flex-1 space-y-2">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-xl bg-zinc-950 hover:bg-zinc-800 text-white text-xs font-semibold flex items-center gap-1.5 shadow-2xs transition active:scale-95 cursor-pointer"
            >
            ...
            <button
              ...
              className="px-2.5 py-1.5 rounded-xl bg-white hover:bg-zinc-100 border border-zinc-200 text-zinc-600 hover:text-zinc-950 text-xs font-medium flex items-center gap-1 transition cursor-pointer"
      ...
      <div className="flex gap-1.5 pt-1">
        <input
          ...
          className="flex-1 bg-white border border-zinc-200 rounded-xl px-2.5 py-1.5 text-xs text-zinc-900 placeholder:text-zinc-400 focus:outline-none focus:border-zinc-950"
        />
        <button
          type="button"
          onClick={handleApplyUrl}
          className="px-3 py-1.5 rounded-xl bg-zinc-100 hover:bg-zinc-200 border border-zinc-200 text-zinc-800 text-xs font-semibold transition cursor-pointer"
        >
          Apply
        </button>
      </div>
