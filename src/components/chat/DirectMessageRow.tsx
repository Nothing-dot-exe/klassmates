  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`flex items-center gap-0.5 mb-1 bg-white dark:bg-[#18181b] border border-zinc-200 dark:border-[#27272a] rounded-2xl px-1.5 py-0.5 shadow-md z-20 opacity-0 group-hover:opacity-100 transition-all duration-200 scale-95 group-hover:scale-100 ${
        ...
        >
          <button
            ...
            className="p-1 rounded-xl text-zinc-400 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-[#222226] transition cursor-pointer"
          ...
          {showReactionPicker && (
            <div className="flex items-center gap-0.5 pl-1.5 border-l border-zinc-200 dark:border-[#27272a]">
        ...
        <div
          className={`relative transition-all duration-300 ${
            ...
            isMine
              ...
              : 'bg-white dark:bg-[#121214] border border-zinc-200/80 dark:border-[#27272a] text-zinc-950 dark:text-zinc-100 rounded-2xl rounded-tl-xs shadow-sm px-3.5 py-2'
          }`}
        >
