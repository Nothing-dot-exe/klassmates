...
export const PendingRequestsTab: React.FC<PendingRequestsTabProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-card border border-zinc-200 dark:border-card-border rounded-3xl p-6 sm:p-8 shadow-sm space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-zinc-200 dark:border-card-border">
        ...
        {passwordResetRequests.length === 0 ? (
          <div className="text-center py-8 border border-dashed border-zinc-200 dark:border-card-border rounded-2xl space-y-2 bg-zinc-50/50 dark:bg-background/40">
            <div className="p-2 bg-zinc-100 dark:bg-card-muted text-zinc-900 dark:text-emerald-400 rounded-xl inline-block border border-zinc-200 dark:border-card-border">
          ...
          <div className="space-y-3">
            {passwordResetRequests.map((pwReq) => (
              <div
                key={pwReq.id}
                className="p-4 rounded-2xl bg-zinc-50 dark:bg-card-muted border border-zinc-200 dark:border-card-border flex flex-col sm:flex-row sm:items-center justify-between gap-3 hover:border-zinc-300 dark:hover:border-indigo-500/40 transition shadow-xs"
              >
                <div className="space-y-1 min-w-0 flex-1">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <span
                      className="font-mono text-xs font-bold text-indigo-600 dark:text-indigo-400 bg-white dark:bg-[#24302c] px-2 py-0.5 rounded border border-zinc-200 dark:border-card-border truncate max-w-[160px] sm:max-w-none flex-shrink-0"
                      title={pwReq.rollNo}
                    >
      ...
      <div className="bg-card border border-zinc-200 dark:border-card-border rounded-3xl p-6 sm:p-8 shadow-sm space-y-6">
        ...
        {pendingRequests.length === 0 ? (
          <div className="text-center py-12 border border-dashed border-zinc-200 dark:border-card-border rounded-2xl space-y-3 bg-zinc-50/50 dark:bg-background/40">
            <div className="p-3 bg-zinc-100 dark:bg-card-muted text-zinc-900 dark:text-emerald-400 rounded-2xl inline-block border border-zinc-200 dark:border-card-border">
