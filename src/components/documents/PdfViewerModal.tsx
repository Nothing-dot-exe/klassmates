...
export const PdfViewerModal: React.FC<PdfViewerModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4 bg-zinc-950/80 dark:bg-black/90 backdrop-blur-md animate-in fade-in transition-colors">
      <div
        className={`bg-white dark:bg-background border-0 sm:border border-zinc-200 dark:border-card-border rounded-none sm:rounded-3xl overflow-hidden shadow-2xl flex flex-col transition-all duration-300 ${
          isFullscreen
      ...
      >
        {/* Header Bar */}
        <div className="flex items-center justify-between gap-2 px-3 sm:px-5 py-2.5 sm:py-3.5 border-b border-zinc-200 dark:border-card-border bg-card/95 backdrop-blur-md flex-shrink-0 transition-colors">
          {/* Document Identity */}
          <div className="flex items-center gap-2.5 min-w-0 flex-1">
            <div className="p-2 sm:p-2.5 rounded-xl sm:rounded-2xl bg-zinc-100 dark:bg-card-muted text-zinc-900 dark:text-indigo-400 border border-zinc-200 dark:border-card-border flex-shrink-0 shadow-xs">
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-1.5 flex-wrap">
                ...
                <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-wider px-1.5 sm:px-2 py-0.2 sm:py-0.5 rounded-full bg-indigo-50 dark:bg-[#24302c] text-indigo-600 dark:text-indigo-400 border border-indigo-200 dark:border-indigo-500/30 flex-shrink-0">
                  PDF
                </span>
              </div>
          ...
          <div className="flex items-center gap-1 sm:gap-1.5 flex-shrink-0">
            ...
            <div className="hidden sm:flex items-center bg-zinc-50 dark:bg-card-muted border border-zinc-200 dark:border-card-border rounded-xl p-0.5">
              <button
                onClick={handleZoomOut}
                disabled={scale <= 0.5}
                title="Zoom Out"
                className="p-1.5 text-zinc-600 dark:text-zinc-300 hover:text-zinc-950 dark:hover:text-white disabled:opacity-30 rounded-lg hover:bg-zinc-200 dark:hover:bg-[#24302c] transition cursor-pointer"
              >
              ...
              <button
                ...
                className="px-2 py-1 text-[10px] font-mono font-bold text-zinc-950 dark:text-white hover:bg-zinc-200 dark:hover:bg-[#24302c] rounded transition cursor-pointer"
              >
            ...
            <button
              ...
              className="hidden sm:flex p-2 text-zinc-600 dark:text-zinc-300 hover:text-zinc-950 dark:hover:text-white bg-zinc-50 dark:bg-card-muted border border-zinc-200 dark:border-card-border rounded-xl hover:bg-zinc-100 dark:hover:bg-[#24302c] transition cursor-pointer shadow-xs"
            >
            ...
            {blobUrl && (
              <a
                ...
                className="p-1.5 sm:p-2 text-zinc-600 dark:text-zinc-300 hover:text-zinc-950 dark:hover:text-white bg-zinc-50 dark:bg-card-muted border border-zinc-200 dark:border-card-border rounded-xl hover:bg-zinc-100 dark:hover:bg-[#24302c] transition shadow-xs flex items-center justify-center cursor-pointer"
              >
            ...
            <button
              onClick={onClose}
              title="Close viewer"
              className="p-1.5 sm:p-2 text-zinc-400 dark:text-zinc-400 hover:text-zinc-950 dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-[#24302c] rounded-xl transition cursor-pointer"
            >
        ...
        {/* Viewport Area */}
        <div className="flex-1 bg-zinc-100 dark:bg-background p-0 sm:p-4 overflow-hidden flex items-center justify-center relative">
          {loadError || !blobUrl ? (
            <div className="max-w-md p-6 sm:p-8 rounded-3xl bg-card border border-zinc-200 dark:border-card-border text-center space-y-4 shadow-xl m-4">
              <div className="w-12 h-12 rounded-2xl bg-zinc-100 dark:bg-card-muted text-zinc-900 dark:text-amber-400 border border-zinc-200 dark:border-card-border flex items-center justify-center mx-auto shadow-xs">
              ...
              <div className="flex items-center justify-center gap-2 pt-2">
                ...
                <button
                  onClick={handleOpenExternal}
                  className="px-4 py-2 bg-zinc-100 dark:bg-[#24302c] hover:bg-zinc-200 dark:hover:bg-[#27272a] text-zinc-800 dark:text-zinc-200 text-xs font-semibold rounded-xl transition flex items-center gap-1.5 border border-zinc-200 dark:border-card-border cursor-pointer"
                >
        ...
        {/* Footer Meta Strip */}
        <div className="px-3 sm:px-5 py-2 sm:py-2.5 border-t border-zinc-200 dark:border-card-border bg-card/95 flex items-center justify-between text-[11px] text-zinc-500 dark:text-zinc-400 flex-shrink-0 transition-colors">
            ...
            {document.tags && document.tags.length > 0 && (
              <div className="hidden sm:flex items-center gap-1">
                ...
                {document.tags.slice(0, 3).map((tag) => (
                  <span key={tag} className="text-[10px] px-1.5 py-0.2 rounded bg-zinc-100 dark:bg-card-muted text-zinc-700 dark:text-zinc-300 font-mono border border-zinc-200 dark:border-card-border">
                    #{tag}
                  </span>
                ))}
              </div>
