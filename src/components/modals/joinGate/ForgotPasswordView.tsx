    ...
    <div className="space-y-4 animate-in fade-in">
      ...
      {!s.isOtpSent ? (
        ...
        <form onSubmit={s.handleResetSubmit} className="space-y-3.5">
          <div className="p-3 rounded-xl bg-zinc-50 dark:bg-card-muted border border-zinc-200 dark:border-card-border space-y-1">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-zinc-50 dark:bg-card-muted border border-zinc-200 dark:border-card-border rounded-xl px-3.5 py-2.5 text-base text-center tracking-widest text-zinc-950 dark:text-white font-mono font-bold focus:bg-white dark:focus:bg-[#24302c] focus:outline-none focus:border-indigo-500 dark:focus:border-indigo-500 transition shadow-xs"
            />
          </div>
