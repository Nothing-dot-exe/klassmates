...
export const ClassRepBanner: React.FC<ClassRepBannerProps> = ({
  ...
  return (
    <div className="relative rounded-2xl bg-gradient-to-b from-slate-100 to-white dark:from-[#161F36] dark:to-[#0E1528] border border-amber-500/25 p-3.5 shadow-xl shadow-black/20 dark:shadow-black/40 overflow-hidden transition-colors">
      ...
      {/* Header: Title & Badges */}
      <div className="flex items-center justify-between pb-2.5 mb-2.5 border-b border-slate-200 dark:border-slate-800/80 relative z-10">
      ...
      <div className="grid grid-cols-1 gap-1.5 pt-0.5 relative z-10">
        {admin.phone && (
          <a
            ...
            className="flex items-center gap-2.5 px-2.5 py-1.5 rounded-xl bg-white/80 dark:bg-slate-900/60 hover:bg-slate-100 dark:hover:bg-slate-800/80 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 hover:text-slate-950 dark:hover:text-white transition-all group shadow-2xs"
          ...
          >
            ...
            <span className="text-[11px] font-mono font-medium tracking-wide text-slate-900 dark:text-slate-200 truncate">
              {admin.phone}
            </span>
          </a>
        )}
        ...
        {admin.email && (
          ...
          >
            ...
            <span className="text-[11px] font-medium tracking-wide uppercase text-slate-900 dark:text-slate-200 truncate">
              {admin.email}
            </span>
          </a>
        )}
