    ...
    <form onSubmit={handleSubmit} className="space-y-4 animate-in fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
        <div>
          ...
          <input
            ...
            className="w-full bg-zinc-50 dark:bg-card-muted border border-zinc-200 dark:border-card-border rounded-xl px-3 py-2 text-xs text-zinc-900 dark:text-white placeholder:text-zinc-400 dark:placeholder:text-zinc-500 focus:outline-none focus:border-indigo-500 focus:bg-white dark:focus:bg-[#24302c] transition shadow-xs"
          />
        </div>
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full bg-zinc-50 dark:bg-card-muted border border-zinc-200 dark:border-card-border rounded-xl px-3 py-2 text-xs text-zinc-900 dark:text-white placeholder:text-zinc-400 dark:placeholder:text-zinc-500 focus:outline-none focus:border-indigo-500 focus:bg-white dark:focus:bg-[#24302c] resize-none leading-relaxed transition shadow-xs"
        />
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              <span className="flex items-center gap-0.5 text-[9px] font-semibold text-zinc-700 dark:text-zinc-300 bg-zinc-100 dark:bg-[#24302c] px-1.5 py-0.2 rounded border border-zinc-200 dark:border-card-border">
            ...
            <input
              ...
              className="w-full bg-zinc-100 dark:bg-[#24302c] border border-zinc-200 dark:border-card-border rounded-xl px-3 py-2 text-xs text-zinc-500 dark:text-zinc-400 font-mono cursor-not-allowed select-none opacity-80"
            />
          </div>
          <div>
            <div className="flex items-center justify-between mb-1">
            ...
            <input
              ...
              className="w-full bg-zinc-100 dark:bg-[#24302c] border border-zinc-200 dark:border-card-border rounded-xl px-3 py-2 text-xs text-zinc-500 dark:text-zinc-400 cursor-not-allowed select-none opacity-80 truncate"
            />
          </div>
        </div>
      ...
      {isClassRep ? (
        <div className="p-3.5 rounded-2xl bg-zinc-50 dark:bg-card-muted border border-zinc-200 dark:border-card-border space-y-1.5 shadow-xs">
        ...
        <div className="p-3.5 rounded-2xl bg-zinc-50 dark:bg-card-muted border border-zinc-200 dark:border-card-border space-y-3 shadow-xs">
          ...
          <label className="flex items-center justify-between cursor-pointer group pt-1 border-t border-zinc-200 dark:border-card-border">
            <div className="flex flex-col pr-2">
              <span className="text-xs font-semibold text-zinc-800 dark:text-zinc-200 group-hover:text-zinc-950 dark:group-hover:text-white transition">
      ...
      <div className="flex gap-2 pt-1">
        <button
          type="button"
          onClick={onCancel}
          className="flex-1 py-2.5 bg-zinc-100 dark:bg-[#24302c] hover:bg-zinc-200 dark:hover:bg-[#27272a] text-zinc-800 dark:text-zinc-200 text-xs font-semibold rounded-xl transition cursor-pointer border border-zinc-200 dark:border-card-border"
        >
          Cancel
        </button>
        <button
