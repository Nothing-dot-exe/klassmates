...
export const DeleteMessageModal: React.FC<DeleteMessageModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-150">
      <div className="w-full max-w-sm rounded-3xl bg-card border border-zinc-200 dark:border-card-border p-5 shadow-2xl space-y-4 animate-in zoom-in-95 duration-200 transition-colors">
        {/* Header */}
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5 text-zinc-900">
            <div className="p-2 rounded-xl bg-zinc-100 dark:bg-[#24302c] border border-zinc-200 dark:border-card-border text-zinc-900 dark:text-rose-400 shadow-xs">
        ...
        <div className="p-2.5 rounded-2xl bg-zinc-50 dark:bg-card-muted border border-zinc-200 dark:border-card-border text-xs text-zinc-700 dark:text-zinc-300 line-clamp-2 italic">
          &ldquo;
        ...
        <div className="space-y-2 pt-1">
          ...
          <button
            ...
            className="w-full py-2.5 px-3 rounded-2xl bg-zinc-100 dark:bg-[#24302c] hover:bg-zinc-200 dark:hover:bg-[#1c2744] active:scale-95 text-zinc-800 dark:text-zinc-200 text-xs font-semibold transition flex items-center justify-center gap-2 border border-zinc-200 dark:border-card-border cursor-pointer shadow-xs"
          >
        ...
        <div className="pt-2 border-t border-zinc-200 dark:border-card-border flex items-center justify-center gap-2">
