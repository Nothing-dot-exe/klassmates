  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`flex items-center gap-0.5 mb-1 bg-white dark:bg-[#252526] border border-zinc-200 dark:border-[#2d2d2d] rounded-2xl px-1.5 py-0.5 shadow-md z-20 opacity-0 group-hover:opacity-100 transition-all duration-200 scale-95 group-hover:scale-100 ${
        ...
        >
          <button
            ...
            className="p-1 rounded-xl text-zinc-400 dark:text-[#858585] hover:text-zinc-900 dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-[#3c3c3c] transition cursor-pointer"
          ...
          {isMine && onDeleteMessage && (
            <button
              ...
              className="p-1 rounded-xl text-zinc-400 dark:text-[#858585] hover:text-rose-600 dark:hover:bg-[#3c3c3c] transition cursor-pointer"
          ...
          {showReactionPicker && (
            <div className="flex items-center gap-0.5 pl-1.5 border-l border-zinc-200 dark:border-[#2d2d2d]">
              {QUICK_REACTIONS.map((emoji) => (
                <button
                  ...
                  className="text-sm hover:scale-125 transition-transform p-0.5 rounded cursor-pointer hover:bg-zinc-100 dark:hover:bg-[#3c3c3c]"
                >
                  {emoji}
                </button>
              ))}
        ...
        <div
          className={`relative transition-all duration-300 ${
            isHighlighted ? 'ring-2 ring-zinc-950 dark:ring-[#007acc] ring-offset-2 ring-offset-white dark:ring-offset-[#1e1e1e] rounded-2xl' : ''
          } ${
            isMine
              ? 'bg-zinc-950 dark:bg-[#0e639c] text-white rounded-2xl rounded-tr-xs shadow-xs px-3.5 py-2'
              : 'bg-white dark:bg-[#252526] border border-zinc-300 dark:border-[#3c3c3c] text-zinc-950 dark:text-[#cccccc] rounded-2xl rounded-tl-xs shadow-2xs px-3.5 py-2'
          }`}
        >
