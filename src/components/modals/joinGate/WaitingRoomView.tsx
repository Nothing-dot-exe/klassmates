  ...
  return (
    <div className="text-center py-6 space-y-4 animate-in fade-in">
      <div className="relative mx-auto w-20 h-20 flex items-center justify-center">
        ...
        <div className="w-16 h-16 rounded-full bg-indigo-50 dark:bg-[#161F36] border border-indigo-200 dark:border-indigo-500/30 flex items-center justify-center text-indigo-600 dark:text-indigo-400 shadow-xs">
      ...
      <div className="p-4 rounded-2xl bg-zinc-50 dark:bg-[#121A2D] border border-zinc-200 dark:border-[#1F2A44] text-left space-y-2">
