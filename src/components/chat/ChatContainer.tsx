    ...
    <div className="flex-1 flex flex-col h-full bg-background overflow-hidden min-h-0 min-w-0 transition-colors">
      ...
      >
        ...
        {currentChannel && currentChannel.name.toLowerCase() === 'general' && (
          <div className="px-3 py-2 sm:px-4 sm:py-2.5 mb-2.5 rounded-2xl bg-amber-500/10 border border-amber-500/25 shadow-xs flex items-center gap-2.5">
            <span className="p-1 rounded-xl bg-amber-500/20 text-amber-600 dark:text-amber-400 shrink-0">
              <Sparkles className="w-3.5 h-3.5" />
            </span>
            <div className="text-[11px] sm:text-xs text-foreground truncate">
