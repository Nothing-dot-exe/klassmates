...
export const AvatarPickerSection: React.FC<AvatarPickerSectionProps> = ({
  ...
  return (
    <div className="p-3.5 rounded-2xl bg-zinc-50 dark:bg-[#121A2D] border border-zinc-200 dark:border-[#1F2A44] space-y-3">
      ...
      <div className="flex items-center gap-3.5">
        {/* Avatar Preview */}
        <div className="relative flex-shrink-0 p-[2px] rounded-full border border-zinc-300 dark:border-[#1F2A44] shadow-2xs">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src={previewAvatar}
            alt="Avatar Preview"
            className="w-16 h-16 rounded-full object-cover bg-zinc-100 dark:bg-[#161F36] ring-2 ring-white dark:ring-[#0E1424]"
          />
        </div>
        ...
        <div className="flex-1 space-y-2">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="px-2.5 py-1.5 rounded-xl bg-white dark:bg-[#161F36] hover:bg-zinc-100 dark:hover:bg-[#1c2744] border border-zinc-200 dark:border-[#1F2A44] text-zinc-600 dark:text-zinc-300 hover:text-zinc-950 dark:hover:text-white text-xs font-medium flex items-center gap-1 transition cursor-pointer"
      ...
      <div className="pt-2 border-t border-zinc-200 dark:border-[#1F2A44] space-y-1.5">
            ...
            <button
              ...
              className={`px-2.5 py-1 rounded-lg text-[11px] font-medium border transition cursor-pointer ${
                avatar === preset.url
                  ...
                  : 'bg-white dark:bg-[#161F36] border-zinc-200 dark:border-[#1F2A44] text-zinc-700 dark:text-zinc-300 hover:text-zinc-950 dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-[#1c2744]'
              }`}
            >
              {preset.label}
            </button>
      ...
      <div className="flex gap-1.5 pt-1">
        <input
          ...
          className="flex-1 bg-white dark:bg-[#161F36] border border-zinc-200 dark:border-[#1F2A44] rounded-xl px-2.5 py-1.5 text-xs text-zinc-900 dark:text-white placeholder:text-zinc-400 dark:placeholder:text-zinc-500 focus:outline-none focus:border-indigo-500"
        />
        <button
          type="button"
          onClick={handleApplyUrl}
          className="px-3 py-1.5 rounded-xl bg-zinc-100 dark:bg-[#161F36] hover:bg-zinc-200 dark:hover:bg-[#1c2744] border border-zinc-200 dark:border-[#1F2A44] text-zinc-800 dark:text-zinc-200 text-xs font-semibold transition cursor-pointer"
        >
          Apply
        </button>
      </div>
