...
export const ProfileSettingsSection: React.FC<ProfileSettingsSectionProps> = ({
  ...
  return (
    <div className="space-y-3.5 pt-2 border-t border-zinc-200 dark:border-[#1F2A44]">
      ...
      <div className="p-3 rounded-2xl bg-zinc-50 dark:bg-[#121A2D] border border-zinc-200 dark:border-[#1F2A44] flex items-center gap-2.5 shadow-xs">
      ...
      <div className="p-3.5 rounded-2xl bg-zinc-50 dark:bg-[#121A2D] border border-zinc-200 dark:border-[#1F2A44] space-y-2 shadow-xs">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1.5 text-xs font-bold text-zinc-900 dark:text-white">
            <Clock className="w-3.5 h-3.5 text-indigo-500 dark:text-indigo-400" />
            <span>Disappearing Messages</span>
          </div>
          <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-white dark:bg-[#161F36] text-indigo-600 dark:text-indigo-400 border border-zinc-200 dark:border-[#1F2A44]">
            ...
            <button
              ...
              className={`py-1.5 text-xs font-semibold rounded-xl border transition cursor-pointer ${
                currentAutoDelete === opt
                  ...
                  : 'bg-white dark:bg-[#161F36] border-zinc-200 dark:border-[#1F2A44] text-zinc-600 dark:text-zinc-300 hover:text-zinc-950 dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-[#1c2744]'
              }`}
            >
      ...
      {onClearAllChat && (
        <button
          ...
          className="w-full py-2.5 rounded-xl bg-zinc-50 dark:bg-[#121A2D] hover:bg-zinc-100 dark:hover:bg-[#161F36] text-zinc-700 dark:text-zinc-300 hover:text-rose-600 dark:hover:text-rose-400 border border-zinc-200 dark:border-[#1F2A44] text-xs font-semibold transition flex items-center justify-center gap-2 cursor-pointer shadow-xs"
        >
      ...
      {onLeaveClassroom && (
        <div className="p-3.5 rounded-2xl bg-zinc-50 dark:bg-[#121A2D] border border-zinc-200 dark:border-[#1F2A44] space-y-2.5 shadow-xs">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-1.5 text-xs font-bold text-zinc-900 dark:text-white">
              <UserMinus className="w-4 h-4 text-zinc-700 dark:text-zinc-300" />
              <span>Leave Classroom</span>
            </div>
            <span className="text-[10px] font-bold px-1.5 py-0.2 rounded bg-zinc-100 dark:bg-[#161F36] text-zinc-800 dark:text-zinc-300 border border-zinc-300 dark:border-[#1F2A44]">
          ...
          {confirmLeave ? (
            <div className="p-3 rounded-xl bg-white dark:bg-[#161F36] border border-zinc-300 dark:border-[#1F2A44] space-y-3 shadow-sm animate-in fade-in">
                ...
                <>
                  ...
                  <div className="space-y-1.5">
                    <select
                      ...
                      className="w-full py-2 px-3 bg-zinc-50 dark:bg-[#121A2D] border border-zinc-300 dark:border-[#1F2A44] rounded-xl text-xs text-zinc-900 dark:text-white focus:outline-none focus:border-indigo-500 cursor-pointer"
                    >
                      <option value="" className="dark:bg-[#121A2D] dark:text-zinc-400">-- Select next Admin from class --</option>
                      {otherStudents.map((cand) => (
                        <option key={cand.id} value={cand.id} className="dark:bg-[#121A2D] dark:text-zinc-200">
                  ...
                  <div className="flex gap-2 pt-1">
                    <button
                      ...
                      className="flex-1 py-1.5 rounded-xl bg-zinc-100 dark:bg-[#121A2D] hover:bg-zinc-200 dark:hover:bg-[#161F36] text-zinc-700 dark:text-zinc-300 text-xs font-medium transition cursor-pointer border border-zinc-200 dark:border-[#1F2A44]"
                    >
                      Cancel
                    </button>
                    <button
                      ...
                      className={`flex-1 py-1.5 rounded-xl text-xs font-bold transition flex items-center justify-center gap-1 shadow-xs ${
                        !selectedSuccessorId
                          ? 'bg-zinc-100 dark:bg-[#121A2D] text-zinc-400 dark:text-zinc-500 cursor-not-allowed border border-zinc-200 dark:border-[#1F2A44]'
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-white dark:bg-[#161F36] hover:bg-zinc-100 dark:hover:bg-[#1c2744] text-zinc-900 dark:text-zinc-200 border border-zinc-300 dark:border-[#1F2A44] text-xs font-bold transition flex items-center justify-center gap-1.5 cursor-pointer active:scale-98 shadow-xs"
            >
              <UserMinus className="w-3.5 h-3.5" />
