...
export const RoomSettingsTab: React.FC<RoomSettingsTabProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-[#0E1424] border border-zinc-200 dark:border-[#1F2A44] rounded-3xl p-4 sm:p-8 space-y-6 shadow-sm">
        <div className="flex items-center gap-3 pb-4 border-b border-zinc-200 dark:border-[#1F2A44]">
        ...
        <form onSubmit={handleSaveSettings} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-zinc-50 dark:bg-[#121A2D] border border-zinc-200 dark:border-[#1F2A44] rounded-xl px-3.5 py-2.5 text-xs sm:text-sm text-zinc-950 dark:text-white font-medium placeholder:text-zinc-400 dark:placeholder:text-zinc-500 focus:border-indigo-500 dark:focus:border-indigo-500 focus:bg-white dark:focus:bg-[#161F36] focus:outline-none transition shadow-xs"
                required
              />
            </div>
          ...
          <div className="space-y-1.5 pt-2">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="w-full bg-zinc-50 dark:bg-[#121A2D] border border-zinc-200 dark:border-[#1F2A44] rounded-xl px-3.5 py-2.5 text-xs sm:text-sm font-mono font-bold text-indigo-600 dark:text-indigo-400 focus:border-indigo-500 dark:focus:border-indigo-500 focus:bg-white dark:focus:bg-[#161F36] focus:outline-none uppercase tracking-wider transition shadow-xs"
              />
              <button
                type="button"
                onClick={handleRegenerateCode}
                className="px-4 py-2.5 rounded-xl bg-zinc-100 dark:bg-[#161F36] hover:bg-zinc-200 dark:hover:bg-[#1F2A44] border border-zinc-200 dark:border-[#1F2A44] text-zinc-900 dark:text-white text-xs font-bold flex items-center gap-1.5 transition flex-shrink-0 cursor-pointer shadow-xs active:scale-95"
              >
          ...
          <div className="pt-4 border-t border-zinc-200 dark:border-[#1F2A44] space-y-4">
            <div className="flex items-center justify-between p-4 rounded-2xl bg-zinc-50 dark:bg-[#121A2D] border border-zinc-200 dark:border-[#1F2A44]">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                ...
                />
                <div className="w-11 h-6 bg-zinc-200 dark:bg-[#161F36] peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-indigo-600 dark:peer-checked:bg-indigo-600 border border-zinc-300 dark:border-[#1F2A44]"></div>
              </label>
            </div>

            <div className="p-4 rounded-2xl bg-zinc-50 dark:bg-[#121A2D] border border-zinc-200 dark:border-[#1F2A44] space-y-2">
              <div className="text-xs font-black text-zinc-950 dark:text-white flex items-center gap-1.5">
              ...
              <select
                ...
                className="w-full bg-white dark:bg-[#161F36] border border-zinc-200 dark:border-[#1F2A44] rounded-xl px-3.5 py-2.5 text-xs font-semibold text-zinc-950 dark:text-white focus:border-indigo-500 focus:outline-none transition shadow-xs cursor-pointer"
              >
        ...
        <form onSubmit={handleUpdateAdminPassword} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full bg-zinc-50 dark:bg-[#121A2D] border border-zinc-200 dark:border-[#1F2A44] rounded-xl px-3.5 py-2.5 text-xs text-zinc-950 dark:text-white placeholder:text-zinc-400 dark:placeholder:text-zinc-500 focus:border-indigo-500 dark:focus:border-indigo-500 focus:bg-white dark:focus:bg-[#161F36] focus:outline-none transition shadow-xs"
            />
          </div>
