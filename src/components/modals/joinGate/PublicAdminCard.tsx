...
export const PublicAdminCard: React.FC<PublicAdminCardProps> = ({ classroom }) => {
  ...
  return (
    <div className="p-3.5 rounded-2xl bg-zinc-50 dark:bg-card-muted border border-zinc-200 dark:border-card-border shadow-xs space-y-2 text-left animate-in fade-in">
      <div className="flex items-center justify-between pb-1.5 border-b border-zinc-200 dark:border-card-border">
      ...
      <div className="flex items-center gap-2.5">
        <div className="w-9 h-9 rounded-xl bg-white dark:bg-[#24302c] text-zinc-900 dark:text-white border border-zinc-200 dark:border-card-border flex items-center justify-center font-bold text-sm shadow-xs">
      ...
      <div className="pt-2 border-t border-zinc-200 dark:border-card-border grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px]">
        {adminPhone ? (
          <a
            href={`tel:${adminPhone}`}
