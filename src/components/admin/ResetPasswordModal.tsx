...
export const ResetPasswordModal: React.FC<ResetPasswordModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in">
      <div className="bg-white dark:bg-[#0E1424] border border-zinc-200 dark:border-[#1F2A44] rounded-3xl w-full max-w-md overflow-hidden shadow-2xl flex flex-col animate-in zoom-in-95 transition-colors">
        <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-200 dark:border-[#1F2A44] bg-zinc-50 dark:bg-[#121A2D]">
          <div className="flex items-center gap-2.5">
            <div className="p-2 rounded-xl bg-zinc-100 dark:bg-[#161F36] text-zinc-900 dark:text-amber-400 border border-zinc-200 dark:border-[#1F2A44]">
        ...
        <div className="p-6 space-y-4">
          <div className="bg-zinc-50 dark:bg-[#121A2D] border border-zinc-200 dark:border-[#1F2A44] rounded-2xl p-4 flex items-center gap-3">
            <img
              src={getSafeAvatar(student.avatar, student.name)}
              alt={student.name}
              className="w-12 h-12 rounded-xl bg-zinc-100 dark:bg-[#161F36] border border-zinc-200 dark:border-[#1F2A44] shadow-xs"
            />
          ...
          <div className="bg-zinc-50 dark:bg-[#121A2D] border border-zinc-200 dark:border-[#1F2A44] rounded-2xl p-4 space-y-2 text-xs text-zinc-700 dark:text-zinc-300">
            ...
            <ul className="list-disc list-inside space-y-1 text-zinc-600 dark:text-zinc-400 text-[11px]">
              <li>
                ...
                <strong className="text-zinc-950 dark:text-white font-mono bg-white dark:bg-[#161F36] px-1.5 py-0.5 rounded border border-zinc-200 dark:border-[#1F2A44]">
