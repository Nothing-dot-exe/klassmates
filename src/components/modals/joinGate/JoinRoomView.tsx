      ...
      <div className="p-3.5 rounded-2xl bg-zinc-50 dark:bg-card-muted border border-zinc-200 dark:border-card-border space-y-2">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-card border border-zinc-300 dark:border-card-border rounded-xl pl-10 pr-4 py-2.5 text-xs text-zinc-950 dark:text-white placeholder:text-zinc-400 dark:placeholder:text-zinc-500 focus:outline-none focus:border-indigo-500 dark:focus:border-indigo-500 font-mono tracking-widest font-extrabold uppercase transition shadow-xs"
          />
        </div>
      </div>
