...
export const AdminHeader: React.FC<AdminHeaderProps> = ({
  ...
  return (
    <div className="border-b border-slate-200 dark:border-slate-800/80 bg-white/95 dark:bg-[#0E1424]/95 backdrop-blur-xl relative sm:sticky sm:top-0 z-20 transition-colors">
      <div className="max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8 py-3.5 sm:py-5 space-y-3.5 sm:space-y-4">
          ...
          <div className="flex items-center gap-2.5 min-w-0 flex-1">
            {onBack && (
              <button
                type="button"
                onClick={onBack}
                className="p-2 rounded-xl bg-slate-100 dark:bg-[#121A2D] text-slate-700 dark:text-slate-200 hover:text-slate-950 dark:hover:text-white border border-slate-200 dark:border-slate-800 transition active:scale-95 cursor-pointer flex-shrink-0"
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap mb-0.5">
                ...
                {classroom.institution && (
                  <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-semibold bg-slate-100 dark:bg-[#121A2D] text-slate-800 dark:text-slate-300 border border-slate-200 dark:border-slate-800 truncate max-w-[150px] sm:max-w-xs">
                    <Building2 className="w-3 h-3 text-slate-500 dark:text-slate-400 flex-shrink-0" />
                    <span className="truncate">{classroom.institution}</span>
                  </span>
                )}
                {classroom.section && (
                  <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-semibold bg-slate-100 dark:bg-[#121A2D] text-slate-800 dark:text-slate-300 border border-slate-200 dark:border-slate-800">
                    <GraduationCap className="w-3 h-3 text-slate-500 dark:text-slate-400 flex-shrink-0" />
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-3.5">
          ...
          <div
            ...
            className="p-3 sm:p-4 rounded-2xl bg-white dark:bg-[#0E1528] hover:bg-slate-50 dark:hover:bg-[#131D36] border border-slate-200 dark:border-slate-800/80 transition duration-200 cursor-pointer flex items-center gap-3 group shadow-xs"
          >
            <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-indigo-50 dark:bg-slate-800 text-indigo-600 dark:text-indigo-400 border border-indigo-100 dark:border-slate-700 flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
              <Users className="w-5 h-5" />
            </div>
            <div className="min-w-0 flex-1">
              <div className="text-lg sm:text-2xl font-black text-slate-900 dark:text-white leading-none">{students.length}</div>
              <div className="text-[10px] sm:text-xs text-slate-800 dark:text-slate-300 font-bold mt-1 truncate">Enrolled Students</div>
              <div className="text-[9.5px] text-slate-500 dark:text-slate-400 font-semibold truncate hidden sm:block">View Class Roster</div>
            </div>
          </div>

          {/* Card 2: Active Online */}
          <div className="p-3 sm:p-4 rounded-2xl bg-white dark:bg-[#0E1528] border border-slate-200 dark:border-slate-800/80 flex items-center gap-3 group shadow-xs">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="text-[10px] sm:text-xs text-slate-800 dark:text-slate-300 font-bold mt-1 truncate">Active Online</div>
              <div className="text-[9.5px] text-slate-500 dark:text-slate-400 font-semibold truncate hidden sm:block">Real-Time Presence</div>
            </div>
          </div>
          ...
          <div
            ...
            className={`p-3 sm:p-4 rounded-2xl border transition duration-200 cursor-pointer flex items-center gap-3 group shadow-xs ${
              pendingCount > 0
                ...
                : 'bg-white dark:bg-[#0E1528] border-slate-200 dark:border-slate-800/80 hover:bg-slate-50 dark:hover:bg-[#131D36]'
            }`}
          >
            <div
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="text-[10px] sm:text-xs text-slate-800 dark:text-slate-300 font-bold mt-1 truncate">Pending Approvals</div>
              <div className="text-[9.5px] text-slate-500 dark:text-slate-400 font-semibold truncate hidden sm:block">
          ...
          {/* Card 4: Invite Code */}
          <div className="p-3 sm:p-4 rounded-2xl bg-white dark:bg-[#0E1528] hover:bg-slate-50 dark:hover:bg-[#131D36] border border-slate-200 dark:border-slate-800/80 transition duration-200 flex items-center justify-between gap-2 group shadow-xs">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <div className="text-[10px] sm:text-xs text-slate-800 dark:text-slate-300 font-bold mt-0.5 truncate">Class Invite Code</div>
              </div>
            </div>
            <button
              type="button"
        ...
        <div className="flex items-center justify-between gap-3 w-full">
          <div className="relative flex items-center gap-1.5 min-w-0 max-w-full w-full sm:w-auto">
            ...
            <div
              ...
              className={`inline-flex items-center gap-1 sm:gap-1.5 p-1 sm:p-1.5 rounded-2xl bg-slate-100 dark:bg-[#0E1424] border border-slate-200 dark:border-slate-800/80 overflow-x-auto no-scrollbar scroll-smooth min-w-0 flex-1 sm:flex-initial shadow-xs select-none ${
                  ...
                  <button
                    ...
                    className={`px-3 py-2 sm:px-4 sm:py-2.5 rounded-xl text-xs font-bold flex items-center gap-2 transition whitespace-nowrap cursor-pointer flex-shrink-0 ${
                      isActive
                        ...
                        : 'text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-white dark:hover:bg-[#161F36]'
                    }`}
                  >
            ...
            {canScrollRight && (
              <button
                ...
                className="p-2 rounded-xl border border-slate-300 dark:border-slate-800 bg-white dark:bg-[#121A2D] text-slate-800 dark:text-white hover:bg-slate-100 dark:hover:bg-slate-800 transition-all flex items-center justify-center flex-shrink-0 cursor-pointer active:scale-95 shadow-xs z-10 animate-pulse"
          ...
          <div className="hidden lg:flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white dark:bg-[#121A2D] border border-slate-200 dark:border-slate-800 text-xs font-semibold text-slate-700 dark:text-slate-300 flex-shrink-0 shadow-xs">
